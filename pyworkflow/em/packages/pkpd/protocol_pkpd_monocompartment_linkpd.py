...
from pk_models import PK_MonocompartmentLinkPD
...
are independent, which are not. Use Bootstrap estimates instead.\n
    ...
    def _defineParams(self, form):
        ...
        form.addParam('bounds', params.StringParam, label="Parameter bounds ([tlag], Cl, V, Clb, Vb, E0, a, b, Cbm)", default="",
    ...
    def createModel(self):
        return PK_MonocompartmentLinkPD()
